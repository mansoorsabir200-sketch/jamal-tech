            ...
            <div className="flex md:hidden ">
              <Sheet>
                ...
                <SheetContent className="bg-blue-900 text-white ">
                  <SheetHeader>
                    <SheetTitle className="text-xl mb-4 duration-1000 text-gray-200">
                      {" "}
                      Jamal tech and software house
                    </SheetTitle>
                    <div className="flex flex-col gap-y-4 items-center    ">
                      ...
                      <a
                        ...
                        className="flex gap-1 justify-center items-center hover:text-blue-400 bg-gray-800 px-12 rounded-sm"
                      >
                        {" "}
